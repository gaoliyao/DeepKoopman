...
params['init_weights'] = 'xavier_uniform'  # PyTorch initialization
params['init_weights_omega'] = 'xavier_uniform'  # PyTorch initialization
...
def main():
    for count in range(200):  # loop to do random experiments
        # Set a different seed for each experiment
        torch.manual_seed(count)
        experiment_params = copy.deepcopy(params)
        training_torch.main_exp(experiment_params)
